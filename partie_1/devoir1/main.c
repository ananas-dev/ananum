...
int main(int argc, char **argv) {
    ...
    // Remplir la matrice avec les valeurs spécifiées
    A[0 * n + 0] = -18.0; A[0 * n + 1] = 9.0; A[0 * n + 2] = 0.0;
    A[1 * n + 0] = 9.0; A[1 * n + 1] = -18.0; A[1 * n + 2] = 0.0;
    A[2 * n + 0] = 0.0; A[2 * n + 1] = 0.0; A[2 * n + 2] = 5.0;
